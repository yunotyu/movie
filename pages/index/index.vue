			...
			<view class="swiper">
				<swiper class="swiper" :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval"
					...
					<swiper-item v-for="(val,key,index) in movieData">
						...
						<u-image v-show="!val.loaded" mode="widthFix" style="height: 200rpx;"  class="swiperImg" src="../../static/images/wait.jpg"></u-image>
						
						<u-image v-show="val.loaded" :lazy-load="false" @load="imgLoaded(val)" class="swiperImg" mode="widthFix" :src="val.swiperImgPath">
							<!-- 图片加载完成显示的图片 -->
